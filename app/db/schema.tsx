...
import {
  ...
  geom_type,
  PredefinedGeometry,
} from "@/classes/vizobjects/geomobj";
...
export const experience = pgTable("experience_table", {
  ...
  user_id: integer("user_id")
    ...
    .notNull(), // foreign key to the profile
...
export type FunctionPlotStringSelect = InferSelectModel<
  typeof FunctionPlotString
>;
export type FunctionPlotStringInsert = InferInsertModel<
  typeof FunctionPlotString
>;
...
export const TableCell = pgTable("table_cell", {
  ...
  stateId: integer("state_id")
    .references(() => states.id, { onDelete: "cascade" })
    .notNull(),
  tableControlId: integer("table_control_id")
    .references(() => TableControl.id, { onDelete: "cascade" })
    .notNull(),
...
export const AttributePairs = pgTable("attribute_pairs", {
  ...
  ControlId: integer("control_id")
    .references(() => SliderControlAdvanced.id, { onDelete: "cascade" })
    .notNull(),
  stateId: integer("state_id")
    .references(() => states.id, { onDelete: "cascade" })
    .notNull(),
...
export type SliderControlAdvancedSelect = InferSelectModel<
  typeof SliderControlAdvanced
>;
export type SliderControlAdvancedInsert = InferInsertModel<
  typeof SliderControlAdvanced
>;
...
export const MultiChoiceOption = pgTable("multi_choice_option", {
  id: serial("id").primaryKey(),
  multiChoiceControlId: integer("multi_choice_control_id")
    .references(() => MultiChoiceControl.id, { onDelete: "cascade" })
    .notNull(),
  stateId: integer("state_id")
    .references(() => states.id, { onDelete: "cascade" })
    .notNull(),
...
export type MultiChoiceControlSelect = InferSelectModel<
  typeof MultiChoiceControl
>;
export type MultiChoiceControlInsert = InferInsertModel<
  typeof MultiChoiceControl
>;

export type MultiChoiceOptionSelect = InferSelectModel<
  typeof MultiChoiceOption
>;
export type MultiChoiceOptionInsert = InferInsertModel<
  typeof MultiChoiceOption
>;
...
export const InputNumberAttributePairs = pgTable(
  "input_number_attribute_pairs",
  {
    id: serial("id").primaryKey(),
    ControlId: integer("control_id")
      .references(() => InputNumberControl.id, { onDelete: "cascade" })
      .notNull(),
    stateId: integer("state_id")
      .references(() => states.id, { onDelete: "cascade" })
      .notNull(),
...
export type InputNumberAttributePairsSelect = InferSelectModel<
  typeof InputNumberAttributePairs
>;
export type InputNumberAttributePairsInsert = InferInsertModel<
  typeof InputNumberAttributePairs
>;

export type InputNumberControlSelect = InferSelectModel<
  typeof InputNumberControl
>;
export type InputNumberControlInsert = InferInsertModel<
  typeof InputNumberControl
>;
...
export const FunctionScore = pgTable("function_score", {
  ...
  desc: text("desc").notNull(),
  functionStr: text("function_str").notNull(),
  functionSymbols: jsonb("function_symbols")
    .$type<AttributePairGet[]>()
    .notNull(),
});
...
export const ValidationObj = pgTable("validation_obj", {
  ...
  obj_id: integer("obj_id").notNull(),
  get_attribute_json: jsonb("get_attribute_json")
    .$type<Attribute_get>()
    .notNull(),
  error: real("error"),
...
export type ValidationTableControlSelect = InferSelectModel<
  typeof ValidationTableControl
>;
export type ValidationTableControlInsert = InferInsertModel<
  typeof ValidationTableControl
>;
...
export const Placement = pgTable("placement", {
  ...
  gridVectors: jsonb("grid_vectors")
...
export type InfluenceAttributePairsSelect = InferSelectModel<
  typeof InfluenceAttributePairs
>;
export type InfluenceAttributePairsInsert = InferInsertModel<
  typeof InfluenceAttributePairs
>;
...
export type InfluenceAdvancedSelect = InferSelectModel<
  typeof InfluenceAdvanced
>;
export type InfluenceAdvancedInsert = InferInsertModel<
  typeof InfluenceAdvanced
>;
...
export type Validation_MultiChoiceInsert =
  typeof Validation_MultiChoice.$inferInsert;
export type Validation_MultiChoiceSelect =
  typeof Validation_MultiChoice.$inferSelect;
...
export type ValidationInputNumberInsert =
  typeof ValidationInputNumber.$inferInsert;
export type ValidationInputNumberSelect =
  typeof ValidationInputNumber.$inferSelect;
